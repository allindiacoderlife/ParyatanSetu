document.addEventListener('DOMContentLoaded', () => {
    ...
    const indianCities = [
        ...
        'Chandigarh', 'Chennai', 'Delhi', 'Goa', 'Hyderabad',
        'Jaipur', 'Kochi', 'Kolkata', 'Lucknow', 'Mumbai',
        'Pune', 'Udaipur', 'Varanasi'
    ].sort();
        ...
        'Mumbai': [
            {
                ...
                services: {
                    specialized: ['Historical Tours', 'Food Tours', 'Bollywood Studio Tours'],
                ...
                description: 'Passionate about showing visitors the real Mumbai, from bustling markets to hidden gems.'
            },
            {
                name: 'Priya Patel',
                age: 28,
                ...
                services: {
                    specialized: ['Art Gallery Tours', 'Photography Tours', 'Fashion District Tours'],
                ...
                description: 'Specializing in cultural and artistic experiences in Mumbai.'
            }
        ],
        'Delhi': [
            {
                ...
                services: {
                    specialized: ['Heritage Walks', 'Historical Monuments', 'Mughal Architecture'],
                ...
                description: 'Expert in Delhi\'s rich history and architectural heritage.'
            }
        ],
        'Bangalore': [
            {
                ...
                services: {
                    specialized: ['Tech Parks Tour', 'Brewery Tours', 'Garden City Tours'],
                ...
                description: 'Showcasing the perfect blend of traditional and modern Bangalore.'
            }
        ],
        'Jaipur': [
            {
                ...
                services: {
                    specialized: ['Palace Tours', 'Heritage Photography', 'Craft Workshops'],
                ...
                description: 'Passionate about sharing the royal heritage of Pink City.'
            }
        ],
        'Goa': [
            {
                ...
                services: {
                    specialized: ['Beach Tours', 'Heritage Houses', 'Church Architecture'],
                ...
                description: 'Expert in Goan culture, history, and adventure activities.'
            }
        ],
        'Varanasi': [
            {
                ...
                services: {
                    specialized: ['Ganga Aarti Tours', 'Ancient City Walks', 'Music Tours'],
                ...
                description: 'Deeply knowledgeable about Varanasi\'s spiritual and cultural heritage.'
            }
        ]
    };

    // Function to display guides
    function displayGuides(city, date) {
        const guidesResults = document.getElementById('guides-results');
        const loader = document.getElementById('loader');
        const noResults = document.getElementById('no-results');
        
        // Get guides for the selected city
        const guides = guidesData[city] || [];
                    ...
                    <div class="guide-card">
                        ...
                        <div class="guide-services">
                            <div class="service-section">
                                ...
                                <ul>${guide.services.specialized.map(s => `<li>${s}</li>`).join('')}</ul>
                            </div>
                            <div class="service-section">
                                <h4>🏃‍♂️ Adventure & Outdoors:</h4>
                                <ul>${guide.services.adventure.map(s => `<li>${s}</li>`).join('')}</ul>
                            </div>
                            <div class="service-section">
                                <h4>🕉️ Spiritual & Religious:</h4>
                                <ul>${guide.services.spiritual.map(s => `<li>${s}</li>`).join('')}</ul>
                            </div>
                        </div>
                        ...
                        <div class="guide-contact">
                            <button class="contact-btn phone-btn" onclick="window.location.href='tel:${guide.contact.phone}'">
                                📞 Call Guide
                            </button>
                            <button class="contact-btn email-btn" onclick="window.location.href='mailto:${guide.contact.email}'">
                                ✉️ Email Guide
                            </button>
                        </div>
                    </div>
    ...
    function performSearch(e) {
        ...
        const isValidCity = indianCities.some(city => 
        ...
        // Simulate API call
        setTimeout(() => {
            displayGuides(destination, selectedDate);
        }, 1000);
    }
});